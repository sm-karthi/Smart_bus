  ...
  function displayBookedTickets(tickets) {
      ...
      if (tickets.length === 0) {
          ...
          tickets.forEach((ticket) => {
              ...
              selectedSeats.innerHTML = `<strong>Selected Seats:</strong> ${
                  Array.isArray(ticket.selectedSeats) ? ticket.selectedSeats.join(", ") : ticket.selectedSeats
              }`;
              ...
              if (ticket.passengerDetails.length > 0) {
                  ...
                  ticket.passengerDetails.forEach((passenger) => {
                      const abbreviatedGender = passenger.gender === "Male" ? "M" : passenger.gender === "Female" ? "F" : passenger.gender;
